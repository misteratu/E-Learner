...
/**
 * Cette classe représente la vue du menu VueControleur.Menus.CM2 dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu VueControleur.Menus.CM2 ne donne accès eux matières enseignées au niveau VueControleur.Menus.CM2
 *
 * @author nolan
 */
public class CM2 extends JFrame {

	private JPanel tabMenuContener;
	private CM2.Controlleur controlleur;
	private ArrayList<JPanel> listButtons;
	private JPanel panelTitle;
	private JPanel contentPane;
	private Menus mainFrame;
    public CM2(ModeleMenu module, Menus mainFrame) {
    ...
    public class Controlleur{
         ...
         *               3 - Lancer le menu Sciences
         *               4 - Lancer le menu Histoire
         *               5 - Lancer le menu Géographie
         *               6 - Relancer le menu Principal
         */
        public void actionToDo(int action){
            switch (action){
				case 1:
					CM2.this.mainFrame.dispose();
					new Quizz("Français","CM2");
					break;
				case 2:
					CM2.this.mainFrame.dispose();
					new Math("CM2");
				...
				case 5:
					CM2.this.mainFrame.dispose();
					new Quizz("geographie","CM2");
					break;
				case 6:
					CM2.this.mainFrame.changeMenu("Niveaux");
					break;
			}
	...
	protected void initComponents() {
		...
		listButtons.add(createButton("Sciences",3));
		listButtons.add(createButton("Histoire",4));
		listButtons.add(createButton("Géographie",5));
