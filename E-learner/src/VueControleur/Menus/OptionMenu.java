...
/**
 * Cette classe représente la vue du menu des paramètres dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu des paramètres donne accès aux menus des paramètres graphiques et sonores.
 *
 * @author nolan
 */
public class OptionMenu extends JFrame {
    ...
    /**
     * Constructeur de la classe OptionMenu
     */

    public OptionMenu(ModeleMenu modele, Menus mainFrame) {
        this.controlleur = new OptionMenu.Controlleur(modele);
    ...
    public class Controlleur{
         ...
         *               1 - Lancer le menu paramètres graphiques
         *               2 - Lancer le menu paramètres sonores
        ...
        public void actionToDo(int action){
            switch (action){
                case 1:
                    OptionMenu.this.mainFrame.changeMenu("Graphiques");
                    break;
                case 2:
                    OptionMenu.this.mainFrame.changeMenu("Sonores");
                    break;
                case 3:
                    OptionMenu.this.mainFrame.changeMenu("Principal");
                    break;
            }
    ...
    /**
     * Cette procédure permet d'initialiser la vue du menu des paramètres
     */
    protected void initComponents() {
        ...
        listButtons.add(createButton("Options sonores",2));
        listButtons.add(createButton("Options graphiques",1));
