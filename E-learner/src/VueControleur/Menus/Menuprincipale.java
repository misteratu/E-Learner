...
/**
 * Cette classe représente la vue du menu principal dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu principal donne accès aux menu des niveaux et au menu des options
 *
 * @author nolan
 */
public class Menuprincipale extends JFrame {

    // Déclaration de tous les élements graphiques
    ...
    public Menuprincipale(ModeleMenu module, Menus mainFrame) {
     ...
     * <p>
     * <p>
     * 1 - Lancer le menu des niveaux
     * 2 - Lancer le menu des paramètres
     * 3 - Quitter
     * 4 - Revenir au Menu
     */
    public class Controlleur {
         ...
         *               1 - Lancer le menu Niveaux
         *               2 - Lancer le menu Paramètre
        ...
        public void actionToDo(int action) {
            switch (action) {
                case 1:
                    Menuprincipale.this.mainFrame.changeMenu("Niveaux");
                    break;
                case 2:
                    Menuprincipale.this.mainFrame.changeMenu("Options");
                    break;
                case 3:
                    break;
                case 4:
                    Menuprincipale.this.mainFrame.dispose();
                    System.exit(0);
                    break;
            }
    ...
    /**
     * Cette fonction permet d'initialiser la vue du menu principal
     */
    protected void initComponents() {
        ...
        listButtons.add(createButton("Jouer",1));
        listButtons.add(createButton("Paramètres",2));
        listButtons.add(createButton("Quitter",4));
    ...
    public JPanel createTitlePanel(){
        ...
        menuTitle.setText("Menu principal");
...
//            public void run() {
//                Menuprincipale menu = new Menuprincipale(new ModeleMenu());
