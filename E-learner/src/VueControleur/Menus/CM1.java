...
/**
 * Cette classe représente la vue du menu VueControleur.Menus.CM1 dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu VueControleur.Menus.CM1 ne donne accès eux matières enseignées au niveau VueControleur.Menus.CM1
 *
 * @author nolan
 */
public class CM1 extends JFrame {
	...
	public CM1(ModeleMenu module, Menus mainFrame) {
    ...
    public class Controlleur{
        ...
        public void actionToDo(int action){
            switch (action){
				case 1:
					CM1.this.mainFrame.dispose();
					new Quizz("Français","CM1");
					break;
				case 2:
					CM1.this.mainFrame.dispose();
					new Math("CM1");
				...
				case 5:
					CM1.this.mainFrame.dispose();
					new Quizz("geographie","CM1");
					break;
				case 6:
					CM1.this.mainFrame.changeMenu("Niveaux");
					break;
			}
