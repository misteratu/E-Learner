...
/**
 * Cette classe représente la vue du menu VueControleur.Menus.CE1 dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu VueControleur.Menus.CE1 ne donne accès eux matières enseignées au niveau VueControleur.Menus.CE1
 *
 * @author nolan
 */
public class CE1 extends JFrame {
	...
	public CE1(ModeleMenu module, Menus mainFrame) {
	...
	public class Controlleur{
		...
		public void actionToDo(int action){
			switch (action){
				case 1:
					CE1.this.mainFrame.dispose();
					new Quizz("Français","CE1");
					break;
				case 2:
					CE1.this.mainFrame.dispose();
					new Math("CE1");
					break;
				case 3:
					CE1.this.mainFrame.changeMenu("Niveaux");
					break;
			}
