...
import Geo.ExempleBoutonForme;

/**
 * Cette classe représente la vue du menu VueControleur.Menus.CE2 dans le cadre du patron de conception MVP.
 * On y retrouve dedans uniquement l'aspect graphique du menu.
 * Le menu VueControleur.Menus.CE2 ne donne accès eux matières enseignées au niveau VueControleur.Menus.CE2
 *
 * @author nolan
 */
public class CE2 extends JFrame {
    ...
    public CE2(ModeleMenu module, Menus mainFrame) {
    ...
    public class Controlleur{
        ...
        public void actionToDo(int action){
            switch (action){
                case 1:
					CE2.this.mainFrame.dispose();
					new Quizz("Français","CE2");
                    break;
                case 2:
                	CE2.this.mainFrame.dispose();
                    new Math("CE2");
                ...
                case 5:
                	CE2.this.mainFrame.dispose();
					new ExempleBoutonForme();
                    break;
                case 6:
					CE2.this.mainFrame.changeMenu("Niveaux");
                    break;
            }
