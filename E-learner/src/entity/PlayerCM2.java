...
import games.ordonnerDecimauxGame;
import games.sommeDureeGame;
import games.volumeGame;
 ...
 *
 */
public class PlayerCM2 extends Player {

	public PlayerCM2(GamePanel gp, KeyHandler KeyH) {
		super(gp, KeyH);
	}
